...
**Step 1:** Open the manager configuration from the dashboard: Menu to Server Management to Settings to Edit Configuration (or edit `/var/ossec/etc/ossec.conf` directly).
