...
2. No banner + RST in tcpdump means firewall/network path. Engage the network team.
3. Banner + SMTP 4xx/5xx means Postfix relay settings: credentials (`sasl_passwd`), TLS (`smtp_use_tls`), allowed sender addresses on the mail service side.
