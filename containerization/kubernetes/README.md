...
| [Load balancing, ingress & proxies](./load-balancing-and-ingress.md) | Exposing agent TCP (1514/1515) versus HTTP (dashboard/API): ingress-nginx TCP services, PROXY protocol, service types, ALB health-check `401` gotcha, dynamic HAProxy load balancing with the Wazuh helper |
