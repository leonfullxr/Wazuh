...
More detail lives in dedicated docs: [`ARCHITECTURE.md`](ARCHITECTURE.md) (consolidated current design + the D-tag decision log), the phase records `ARCHITECTURE-V3*.md`, and [`ENHANCEMENTS.md`](ENHANCEMENTS.md). Diagram sources are in [`diagrams/`](diagrams/), exports in [`diagrams/png/`](diagrams/png/).
...
| `ARCHITECTURE.md`, `ARCHITECTURE-V3*.md`, `ENHANCEMENTS.md` | Design (current) and phase records |
